...
<div class="jumbotron jumbotron-fluid jumbotron1">
    <div class="container">
        <h1 class="bordeBot">Coronavirus (COVID-19)</h1>  
    </div>
</div>
...
<div class="container borde">
        <div class="texto">
            <h1><span class="bordeIzquierdaFino"></span>¿Qué es un coronavirus?</h1>
            <p>Los coronavirus son una extensa familia de virus que pueden causar enfermedades tanto en animales como en humanos. En los humanos, se sabe que varios coronavirus <strong>causan infecciones respiratorias</strong> que pueden ir desde el resfriado común hasta enfermedades más graves como el <strong>síndrome respiratorio de Oriente Medio (MERS) y el síndrome respiratorio agudo severo (SRAS).</strong>  El coronavirus que se ha descubierto más recientemente causa la enfermedad por coronavirus COVID-19.
                </p>
